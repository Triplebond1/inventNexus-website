    ...
    <div className="p-5 border rounded-lg border-dashed border-gray-400">
      ...
      {file && (
        <div className="mt-4 space-x-2">
          <button
            onClick={uploadFile}
            className="px-4 py-2 bg-blue-500 text-white rounded-lg bg-blaze-orange-600 hover:bg-blaze-orange-600"
          >
            Upload File
          </button>
          <button
            onClick={cancelUpload}
            className="px-4 py-2 bg-red-500 text-white rounded-lg bg-blaze-orange-600 hover:bg-blaze-orange-600"
          >
            Cancel
          </button>
        </div>
