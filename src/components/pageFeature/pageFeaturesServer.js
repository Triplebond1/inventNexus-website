...
export const SocialMediaLink = ({ Name, Icon, Href }) => {
  return (
    <div className="container h-12 flex items-center m-auto">
      <Link
        href={Href}
        className="bg-blaze-orange-200 p-2 text-black rounded-lg hover:underline hover:text-blaze-orange-600 on-active:text-blaze-orange-600 font-semibold flex justify-items-center my-auto items-center gap-2"
      >
        {Name}
        <Icon/>
      </Link>
